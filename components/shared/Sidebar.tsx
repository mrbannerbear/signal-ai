...
import { 
  LayoutDashboard, UserCircle, Briefcase, Settings, 
  ...
  return (
    <aside className={cn(
      ...
      <div className="h-16 flex items-center px-6 border-b border-slate-100 mb-4">
        ...
        {!isCollapsed && <span className="ml-3 font-bold tracking-tight text-slate-900 text-lg">Signal</span>}
      </div>
      ...
      <div className="px-4 mb-6">
        <Button className={cn(
          ...
          {!isCollapsed && <span className="font-semibold text-sm">Analyze</span>}
        </Button>
      </div>
